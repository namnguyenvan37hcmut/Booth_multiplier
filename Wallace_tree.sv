...
module Wallace_Tree(input logic [31:0] PP1,PP2,PP3,PP4,PP5,PP6,PP7,PP8,

output logic [31:0] product);

    //Stage-1

    logic [31:0] S1A1_PS,S1A1_PC,S1A2_PS,S1A2_PC;
   ...
   logic [31:0] S2A1_PS,S2A1_PC,S2A2_PS,S2A2_PC;
